      ...
      <ul class="list-unstyled accordion-menu">
        ...
        <li>
          <a href="file-manager.html"
            ><i data-feather="message-circle"></i>File Manager</a
          >
        </li>
        <li class="sidebar-title">Elements</li>
        <li>
          <a href="index.html"
            ><i data-feather="code"></i>Components<i
          ...
          <ul class="">
            ...
            <li>
              <a href="typography.html"
                ><i class="far fa-circle"></i>Typography</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="dropdowns.html"
                ><i class="far fa-circle"></i>Dropdowns</a
              >
            </li>
            <li>
              <a href="list-group.html"
                ><i class="far fa-circle"></i>List Group</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="pagination.html"
                ><i class="far fa-circle"></i>Pagination</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="accordion.html"
                ><i class="far fa-circle"></i>Accordion</a
              >
            </li>
          </ul>
        </li>
        <li>
          <a href="index.html"
            ><i data-feather="gift"></i>Plugins<i
              class="fas fa-chevron-right dropdown-icon"
            ></i
          ></a>
          <ul class="">
            ...
            <li>
              <a href="tree-view.html"
                ><i class="far fa-circle"></i>Tree View</a
              >
            </li>
          </ul>
        </li>
          ...
          <ul class="">
            ...
            <li>
              <a href="form-layout.html"
                ><i class="far fa-circle"></i>Form Layout</a
              >
            </li>
            <li>
        ...
        <li>
          <a href="index.html"
            ><i data-feather="list"></i>Tables<i
              class="fas fa-chevron-right dropdown-icon"
            ></i
          ></a>
          <ul class="">
            <li>
              <a href="tables.html"
                ><i class="far fa-circle"></i>Basic Tables</a
              >
            </li>
            <li>
              <a href="data-tables.html"
                ><i class="far fa-circle"></i>Data Tables</a
              >
            </li>
          </ul>
        </li>
        ...
        <li class="active-page">
          ...
          <ul class="">
            <li>
              <a href="invoice.html"><i class="far fa-circle"></i>Invoice</a>
            </li>
            <li>
            ...
            <li>
              <a href="blank-page.html" class="active"
                ><i class="far fa-circle"></i>Blank Page</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="lockscreen.html"
                ><i class="far fa-circle"></i>Lockscreen</a
              >
            </li>
            <li>
